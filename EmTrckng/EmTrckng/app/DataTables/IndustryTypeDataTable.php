...
class IndustryTypeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'industry_types.datatables_actions');
    }
     ...
     */
    public function query(IndustryType $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'order'     => [[0, 'desc']],
                'buttons'   => [
                    ['extend' => 'create', 'className' => 'btn btn-info btn-sm no-corner ml-2','title' => __('datatables.bcreate')],
    ...
    {
        return 'industry_types_datatable_' . time();
    }
}