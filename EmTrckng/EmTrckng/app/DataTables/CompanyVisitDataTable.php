...
class CompanyVisitDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'company_visits.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CompanyVisit $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CompanyVisit $model)
    {
    ...
    {
        return 'company_visits_datatable_' . time();
    }
}
